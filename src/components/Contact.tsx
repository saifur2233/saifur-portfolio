          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span>saifurnstuiit223344@gmail.com</span>
              </a>
              <a
              ...
              >
                ...
                <span>github.com/saifur2233</span>
              </a>
              <a
                href="https://linkedin.com/in/saifur-rahman2233/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
              >
                <Linkedin className="w-6 h-6" />
                <span>linkedin.com/in/saifur-rahman2233/</span>
              </a>
            </div>
          </div>
