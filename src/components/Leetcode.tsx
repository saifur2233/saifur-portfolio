      ...
      <div className="container mx-auto max-w-6xl px-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full h-[25rem] overflow-hidden">
            <iframe
            src="https://leetcard.jacoblin.cool/saifurnstuiit223344?theme=dark&font=Inter&ext=activity&border=2&radius=10"
          ...
          <div>
            ...
            <p className=" text-center text-lg text-gray-600 dark:text-gray-300">
              I've completed 47 of problems across a variety of topics,
